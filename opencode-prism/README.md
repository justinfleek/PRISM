...
**64 OKLCH Color Science Themes** for [OpenCode](https://opencode.ai) - the AI coding assistant for your terminal.
...
| **fleek-gold** | Warm gold monochromatic elegance |
| **fleek-gradient** | Yellow-green gradient accent |
| **tessier** | Tessier-Ashpool corporate aesthetic |
...
Created by [Fleek](https://fleek.sh) for the developer community.
