...
-- 6. Golden angle optimality (Three-Distance Theorem)

/-! ## Key Mathematical Constants -/

-- Golden Angle = 360 * (1 - 1/phi) = 360 * (2 - phi) = 137.5077640500378...
-- 
-- In RADIANS: 2*pi / phi^2 = 2.399963229728653...
-- 
-- Why this matters for color themes:
-- - Generates maximally separated hues regardless of count
-- - No "clumping" - colors always well-distributed  
-- - Based on the Three-Distance Theorem (proven optimal)
