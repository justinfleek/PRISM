;;; ayu_mirage-theme.el --- Prism Ayu Mirage theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Ayu Mirage color theme - Auto-generated from vscode/themes
;;; Code:

(deftheme ayu_mirage
  "Prism Ayu Mirage - A #73d0ff theme.")
