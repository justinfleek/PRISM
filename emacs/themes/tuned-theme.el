;;; tuned-theme.el --- Prism Tuned theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Tuned color theme - Auto-generated from vscode/themes
;;; Code:

(deftheme tuned
  "Prism Tuned - A #3888c8 theme.")
