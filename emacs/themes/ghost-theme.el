;;; ghost-theme.el --- Prism Ghost theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Ghost color theme - Auto-generated from vscode/themes
;;; Code:

(deftheme ghost
  "Prism Ghost - A #2060a0 theme.")
