;;; palenight-theme.el --- Prism Palenight theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Palenight color theme - Auto-generated from vscode/themes
;;; Code:

(deftheme palenight
  "Prism Palenight - A #ffcb6b theme.")
