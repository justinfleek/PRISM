;;; forest-theme.el --- Prism Forest theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Forest color theme - Auto-generated from vscode/themes
;;; Code:

(deftheme forest
  "Prism Forest - A #62A527 theme.")
